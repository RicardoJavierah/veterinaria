...
public class Validacion {
	public static final String NUM_CLIENTE = "[1-9]{1,4}";
	public static final String NOMBRE_MASCOTA = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{2,40}";
	public static final String RAZA_MASCOTA = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{2,20}";
	public static final String COLOR_MASCOTA = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{2,20}";
	public static final String ALERGIA_ATENCION = "(si|no)";
	public static final String NOMBRE_DUENIO = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{2,50}";
	public static final String TELF_DUENIO = "[0-9]{9}";
	public static final String OBSERVACIONES ="[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s\\,\\.]{2,255}";
	...
	public static final String NUMERO_ALUMNOS = "[0-9]{1,1000}";
	public static final String RECURSOS = "[a-zA-Z\\s]";
	public static final String DIRECCION = "[0-9a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{3,200}";
